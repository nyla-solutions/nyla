...
/**
 * Connection implementations that adds the connection back to the pool the closed
...
public class PoolConnection implements Connection {
    ...
    public PoolConnection(Connection connection, Pool<Connection> pool) {
        if(connection == null)
            throw new IllegalArgumentException("connection not provided to pool connection");

        if(pool == null)
            throw new IllegalArgumentException("pool not provided to pool connection");
